...
No sleep, Wi-Fi, DNS, IP, network-service, IPv4/IPv6 availability, System Proxy or TUN mutation was performed. A separate Clash Verge Mihomo runtime and its `utun1024` route were active and intentionally left untouched.
